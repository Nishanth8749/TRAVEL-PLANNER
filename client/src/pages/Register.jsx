...
import { FaPlane, FaUser, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaSpinner } from 'react-icons/fa';
      ...
      >
        <div className="glass-card dark:bg-dark-100/90 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">Create your account and start exploring</p>
          </div>
